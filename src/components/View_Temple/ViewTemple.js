...
import { useState,useEffect } from "react";
 ...
 function ViewTemple(){
    ...
    return(
        <div className='container d-flex flex-row flex-wrap gap-5 justify-content-center'> 
             
             {
                templeList.map(
                    ...
                    <div key={index} className='col-md-3 mb-4'>
                        <div className="card">
                        <img class="card-img-top" src="https://images.unsplash.com/photo-1524443169398-9aa1ceab67d5?q=80&w=1448&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Card image cap"/>
